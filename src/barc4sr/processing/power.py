...
def integrate_power_density_window(pwrDict, hor_slit, ver_slit, observation_plane=None):
    """
    ...
    ----------
    pwrDict : dict
        Dictionary containing power density data as produced by write_power_density.
    ...
    -------
    dict
        Dictionary with structure {polarisation: integrated_value, ...},
        plus the window used:
            - 'hor_slit': (x_min, x_max) in meters
            - 'ver_slit': (y_min, y_max) in meters
    """
